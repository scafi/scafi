...
import it.unibo.scafi.simulation.gui.launcher.scafi.{ListDemo, Console => ScafiConsole, GraphicsLauncher => ScafiGraphicsLauncher, StringLauncher => ScafiStringLauncher}
