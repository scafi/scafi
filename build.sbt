...
val akkaVersion = "2.8.1" // NOTE: Akka 2.4.0 REQUIRES Java 8! NOTE: Akka 2.6.x drops Scala 2.11
...
val slf4jlog4 = "org.slf4j" % "slf4j-log4j12" % "2.0.7"
val log4 = "org.apache.logging.log4j" % "log4j-core" % "2.20.0"
