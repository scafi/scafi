...
val bcel = "org.apache.bcel" % "bcel" % "6.8.2"
...
val slf4jlog4 = "org.slf4j" % "slf4j-log4j12" % "2.0.12"
...
lazy val spala = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      scopt,
      scalaBinaryVersion.value match {
        case "2.11" => "com.typesafe.play" %% "play-json" % "2.10.4"
        case "2.12" | "2.13" => "com.typesafe.play" %% "play-json" % "2.10.4"
      },
      slf4jlog4,
      log4
    )
