...
/**
 * utility to set information on graphics log you can change graphics configuration associated to some channel like
 * this: <pre> {@code GraphicsLogger.addStrategy("output",LogType.textual } </pre>
 */
