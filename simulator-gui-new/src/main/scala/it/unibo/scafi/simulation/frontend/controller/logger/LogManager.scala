package it.unibo.scafi.simulation.frontend.controller.logger
...
object LogManager extends SimpleSource {
  ...
  /**
    ...
    * @param channel the set of channel
    */
  ...
  sealed trait Log[V] extends Event {
    ...
    /**
      * @return a label associated to value
      */
    def label : String
  ...
  /**
    ...
    * @param label associated to value
  ...
  /**
    ...
    * @param channel log channel
    * @param label associated to value
    * @param value the generic value to log
    */
  ...
  object FileOutputObserver extends LogObserver {
    import it.unibo.scafi.simulation.frontend.util.FileUtil._
