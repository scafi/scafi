...
import it.unibo.scafi.simulation.s2.frontend.controller.logger.LogManager.LogObserver
...
/**
 * standard fx graphics logger used to show log accepted by default FXLogger has standard representation for some log
 * type:
