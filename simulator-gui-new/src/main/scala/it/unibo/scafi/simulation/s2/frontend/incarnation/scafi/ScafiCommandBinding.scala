...
import it.unibo.scafi.simulation.s2.frontend.incarnation.scafi.configuration.command.{AbstractMoveCommandFactory, AbstractToggleCommandFactory}
...
import it.unibo.scafi.simulation.s2.frontend.view.{AbstractKeyboardManager, AbstractSelectionArea}
