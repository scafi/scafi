...
import it.unibo.scafi.simulation.s2.frontend.model.simulation.implementation.mutable.SensorDefinition
import it.unibo.scafi.simulation.s2.frontend.model.simulation.implementation.mutable.StandardNodeDefinition

/**
 * scafi world definition
 */
trait ScafiLikeWorld
    extends SensorPlatform
    with World3D
