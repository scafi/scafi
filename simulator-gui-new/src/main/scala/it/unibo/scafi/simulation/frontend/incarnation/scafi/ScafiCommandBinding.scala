...
import it.unibo.scafi.simulation.frontend.configuration.command.factory.SimulationCommandFactory
...
import it.unibo.scafi.simulation.frontend.incarnation.scafi.configuration.command.{AbstractMoveCommandFactory, AbstractToggleCommandFactory}
import it.unibo.scafi.simulation.frontend.incarnation.scafi.configuration.command.AbstractToggleCommandFactory.MultiToggleCommandFactory
import it.unibo.scafi.simulation.frontend.view.AbstractKeyboardManager._
