package it.unibo.scafi.simulation.frontend.configuration.logger

import it.unibo.scafi.simulation.frontend.controller.logger.LogManager
import it.unibo.scafi.simulation.frontend.view.scalaFX
import it.unibo.scafi.simulation.frontend.view.scalaFX.logger.FXLogger
