...
import it.unibo.scafi.simulation.frontend.model.sensor.SensorConcept.{SensorDevice, sensorOutput}
import it.unibo.scafi.simulation.frontend.view.ViewSetting._
import it.unibo.scafi.simulation.frontend.view.scalaFX.modelShapeToFXShape
