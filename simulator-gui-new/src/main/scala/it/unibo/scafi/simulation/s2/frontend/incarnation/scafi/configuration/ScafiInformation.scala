...
import it.unibo.scafi.simulation.s2.frontend.configuration.parser.{Parser, UnixLikeParser}
...
import it.unibo.scafi.simulation.s2.frontend.view.scalaFX.drawer.{FastFXOutput, StandardFXOutput}
