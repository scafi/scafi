package it.unibo.scafi.simulation.frontend.model.simulation

import it.unibo.scafi.simulation.frontend.model.aggregate.{AbstractAggregateWorld, AbstractNodeDefinition}
import it.unibo.scafi.simulation.frontend.model.common.BoundaryDefinition
import it.unibo.scafi.simulation.frontend.model.common.network.ConnectedWorld
import it.unibo.scafi.simulation.frontend.model.sensor.{SensorConcept, SensorNetwork, SensorWorld}
