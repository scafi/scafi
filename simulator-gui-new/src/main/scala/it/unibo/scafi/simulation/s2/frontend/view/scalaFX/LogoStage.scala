...
import it.unibo.scafi.simulation.s2.frontend.view.WindowConfiguration.FullScreen
import it.unibo.scafi.simulation.s2.frontend.view.WindowConfiguration.Window
import it.unibo.scafi.simulation.s2.frontend.view.scalaFX.pane.Logo
