...
import it.unibo.scafi.simulation.frontend.configuration.command.Command.command
...
abstract class AbstractMoveCommandFactory extends CommandFactory {
  ...
  protected def move(movedMap : Map[ID,P]) : Command = {
    import it.unibo.scafi.simulation.frontend.incarnation.scafi.bridge.ScafiBridge._
