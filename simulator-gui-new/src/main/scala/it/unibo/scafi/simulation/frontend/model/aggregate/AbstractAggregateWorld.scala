package it.unibo.scafi.simulation.frontend.model.aggregate

import it.unibo.scafi.simulation.frontend.model.aggregate.AggregateEvent._
import it.unibo.scafi.simulation.frontend.model.common.world.{AbstractObservableWorld, CommonWorldEvent}
