...
import it.unibo.scafi.simulation.frontend.controller.logger.LogManager.{IntLog, Log, LogObserver, TreeLog}
import it.unibo.scafi.simulation.frontend.view.{GraphicsLogger, scalaFX}
