...
import it.unibo.scafi.simulation.frontend.model.aggregate.AggregateEvent.{NodeDeviceAdded, NodeDeviceRemoved, NodesMoved}
import it.unibo.scafi.simulation.frontend.model.common.network.ConnectedWorld.NeighbourChanged
import it.unibo.scafi.simulation.frontend.model.common.world.CommonWorldEvent.{NodesAdded, NodesRemoved}
import it.unibo.scafi.simulation.frontend.model.sensor.SensorEvent.SensorChanged
