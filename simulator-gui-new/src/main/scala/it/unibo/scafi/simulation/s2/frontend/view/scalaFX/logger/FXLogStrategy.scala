...
import it.unibo.scafi.simulation.s2.frontend.controller.logger.LogManager.{DoubleLog, IntLog, Log, TreeLog}
import it.unibo.scafi.simulation.s2.frontend.view.GraphicsLogger
import it.unibo.scafi.simulation.s2.frontend.view.GraphicsLogger.{LogType, textual}
