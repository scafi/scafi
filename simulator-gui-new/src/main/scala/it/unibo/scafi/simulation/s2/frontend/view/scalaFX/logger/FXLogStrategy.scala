...
import it.unibo.scafi.simulation.s2.frontend.controller.logger.LogManager.DoubleLog
import it.unibo.scafi.simulation.s2.frontend.controller.logger.LogManager.IntLog
import it.unibo.scafi.simulation.s2.frontend.controller.logger.LogManager.Log
...
import it.unibo.scafi.simulation.s2.frontend.view.GraphicsLogger.textual
...
object FXLogStrategy {
  /**
   * simple factory, create a log strategy with log type passed
   * @param logType
   *   the log type passed
   * @return
   *   log strategy
